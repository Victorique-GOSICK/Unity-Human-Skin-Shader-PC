 Shader "MStdio/Standard Specular Skin" {
	Properties {
		...
		_SpecularColor("Specular Color", Range(0,1)) = 0.2
		_SSSBlurIntensity("SSS Blur Intensity", Range(0, 1)) = 0.1
		_TransIntensity("Light trans intensity", Range(0,1)) = 0
...
struct appdata_tess{
    ...
    float4 texcoord2 : TEXCOORD2;
		...
		inline void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
			...
			o.Specular = _SpecularColor * spec.rrr;
...
inline void frag_surf (v2f_surf IN,
  ...
  outGBuffer1.b = _TransIntensity;
  outGBuffer1.g = _SSSBlurIntensity;
  outGBuffer2.a = 0.5;
  #if defined(SHADOWS_SHADOWMASK) && (UNITY_ALLOWED_MRT_COUNT > 4)
